...
<nav class="sidebar" id="sideBar">
    ...
    <ul class="side-menu">
        <li class="side-list"><a href="index.php" class="side-link"><p>Dashboard</p></a></li>
        <li class="side-list"><a href="index.php?p=add_doc" class="side-link"><p>ส่งเอกสาร</p></a></li>
        <li class="side-list"><a href="" class="side-link"><p>รายการส่งเอกสาร</p></a></li>
        <li class="side-list"><a href="index.php?p=users" class="side-link"><p>ผู้ใช้งาน</p></a></li>
